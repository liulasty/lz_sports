...
validation_commands:
  ...
  - powershell -ExecutionPolicy Bypass -File scripts/smoke-suite.ps1 -BackendUrl http://localhost:8080 -FrontendUrl http://localhost:5173 -EventId 1 -AccountsFile git-ai/automation-route/runs/business-accounts-latest.json -RunId 2026-04-18-auto-063 -RelatedTaskId AUTO-039
  - powershell -ExecutionPolicy Bypass -File scripts/smoke-user-status.ps1 -BackendUrl http://localhost:8080 -AccountsFile git-ai/automation-route/runs/business-accounts-latest.json -RunId 2026-04-18-auto-063-user-status -RelatedTaskId AUTO-039
