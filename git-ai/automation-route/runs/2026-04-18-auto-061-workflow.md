run_id: 2026-04-18-auto-061-workflow
related_task_id: AUTO-038
changed_files:
  - scripts/smoke-event-workflow.ps1
  - git-ai/automation-route/runs/2026-04-18-auto-061-workflow.md
key_changes:
...
issue_inputs:
  - source: local-run
    signal: "athlete-reapply failed: expected [200], got code=409, msg=æ¨çè¯·æ±è¿äºé¢ç¹ï¼è¯·ç¨ååè¯"
token_source:
