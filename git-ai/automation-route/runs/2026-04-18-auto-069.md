run_id: 2026-04-18-auto-069
related_task_id: AUTO-069
changed_files:
  - scripts/smoke-suite.ps1
  - git-ai/automation-route/runs/2026-04-18-auto-069.md
key_changes:
...
test_results:
  ...
  - sub_runs:
      oneclick: "2026-04-18-auto-069-oneclick"
      event_workflow: "2026-04-18-auto-069-workflow"
risks:
...
issue_inputs:
  - source: local-run
    signal: "register-seed-users failed with exit code 1"
repeated_failures:
