run_id: 2026-04-18-auto-045
related_task_id: AUTO-034
changed_files:
  - scripts/smoke-event-workflow.ps1
  - git-ai/automation-route/runs/2026-04-18-auto-045.md
key_changes:
...
issue_inputs:
  - source: local-run
    signal: "athlete-apply failed: expected [200], got code=409, msg=å·²è¾¾å°æ¬èµäºæå¤æ¥å3ä¸ªé¡¹ç®çéå¶"
token_source:
