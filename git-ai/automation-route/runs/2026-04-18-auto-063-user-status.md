run_id: 2026-04-18-auto-063-user-status
related_task_id: AUTO-039
changed_files:
  - scripts/smoke-user-status.ps1
  - git-ai/automation-route/runs/2026-04-18-auto-063-user-status.md
key_changes:
...
issue_inputs:
  - source: local-run
    signal: "disabled-login failed: expected [500], got code=409, msg=è´¦å·å·²ç¦ç¨ï¼è¯·èç³»ç®¡çå"
repeated_failures:
